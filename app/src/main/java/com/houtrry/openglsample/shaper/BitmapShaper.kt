...
class BitmapShaper(private val bitmap: Bitmap) : IShaper {
    ...
    override fun onCreate(context: Context) {
        ...
        val vertexShaper: Int = OpenglUtils.loadShaper(
            GLES20.GL_VERTEX_SHADER, context.readRawText(R.raw.bitmap_vertex)
        ) ?: kotlin.run {
        ...
        val fragmentShaper: Int = OpenglUtils.loadShaper(
            GLES20.GL_FRAGMENT_SHADER, context.readRawText(R.raw.bitmap_fragment)
        ) ?: kotlin.run {
